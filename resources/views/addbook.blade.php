...
<div class="container">
    ...
    <form action="/insertbook" method="post" class="form-group" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="form-group row">
            <label for="booksName" class="col-sm-2 col-form-label">Books Name</label>
            <input type="text" name="booksName" id="booksName" class="col-sm-8 form-control m-2" required>
        </div>
        <div class="form-group row">
            <label for="booksImage" class="col-sm-2 col-form-label">Cover Image</label>
            <input type="file" name="booksImage" id="booksImage" class="col-sm-8 form-control-file m-2 ">
